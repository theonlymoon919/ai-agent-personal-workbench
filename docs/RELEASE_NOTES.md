# AI Agent 个人工作台 v0.3.0-alpha.3

这是完成整体品牌升级后的公开预发布安装版。项目现以“AI Agent 个人工作台”对外展示，更准确地表达它是由用户掌控数据、可连接各类兼容 Agent 的长期记忆与行动系统。它仍处于 Alpha 阶段，适合自托管体验、测试和反馈；保存重要数据前请先建立备份方案。

## 下载安装

- [中文发行版安装指南](https://github.com/theonlymoon919/ai-agent-personal-workbench/blob/v0.3.0-alpha.3/docs/RELEASE_INSTALL.zh-CN.md)
- [完整中文安装与使用说明书](https://github.com/theonlymoon919/ai-agent-personal-workbench/blob/v0.3.0-alpha.3/docs/USER_GUIDE.zh-CN.md)
- 服务器镜像：`ghcr.io/theonlymoon919/ai-agent-personal-workbench:0.3.0-alpha.3`
