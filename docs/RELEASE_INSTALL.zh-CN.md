...
本指南面向第一次接触“AI Agent 个人工作台”的普通用户。当前版本是 `v0.3.0-alpha.5` 预发布测试版，重要数据请自行备份。
...
```bash
git clone --branch v0.3.0-alpha.5 https://github.com/theonlymoon919/ai-agent-personal-workbench.git
...
WORKBENCH_IMAGE_TAG=0.3.0-alpha.5
```
...
更完整的手机、HTTPS、Agent、Hermes、备份和故障排查说明见[《中文安装与使用说明书》](https://github.com/theonlymoon919/ai-agent-personal-workbench/blob/v0.3.0-alpha.5/docs/USER_GUIDE.zh-CN.md)。
